...
public class c4_StringMethods3 {
    ...
    public static void main(String[] args) {
        ...
        String weather = goodOrBad.next();

        if (weather.equals("Good")) {

            System.out.println("What is the tempreture");
            String tempreture = goodOrBad.next();

            System.out.println("Weather is Good and temreture is " + tempreture);

        } else {
            System.out.println("Never mind! Weather is not good!");
        }
    }
}